								...
								<tr>
									...
									<td colspan="7">
										<div class="mm_selected">
											...
											<a class="mm_btn T=line" href="/search/influencer" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>인플루언서 검색</b></a>
											<!--
												<ul>
												<li>
												<b>인플루언서 A</b>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="coop/register" data-href title="새 창 열림"><b>상품 등록하기</b><i class="ico_register"></i></a>
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="coop/modify" title="새 창 열림"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
