								...
								<tr>
									...
									<td colspan="3">
										<div class="mm_selected">
											...
											<a class="mm_btn T=line" href="/search/middle-single" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>셀러 검색</b></a>
											<!--
												<ul>
												<li>
												<b>셀러 A</b>
						...
						<div class="mm_form">
							<table>
								<tbody>
									...
									<tr>
										<th scope="row">
											<b>세트 관리명<i class="ico_required" title="필수입력"></i></b>
										</th>
										<td colspan="3">
											...
											<div class="mm_note">
												<p>관리자에서 관리될 명칭으로 프론트에 노출되지 않습니다</p>
											</div>
										</td>
									</tr>
								</tbody>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="mm_table-item">
													<span class="text_price">30500</span>
												</div>
											</td>
											<td>
												<div class="mm_table-item">
										...
										<tr>
											...
											<td>
												<div class="mm_table-item">
													<span class="text_price">80000</span>
												</div>
											</td>
											<td>
												<div class="mm_table-item">
