		...
		<template #content>
			<div class="mm_page-content">
				...
				<div class="mm_container">
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a class="mm_btn T=sm T=line" href="/product/confirm/history" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>보기</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
														<a class="mm_btn T=sm T=line" href="/product/confirm/reject-detail" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>반려사유</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a class="mm_btn T=sm T=line" href="/product/option" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>옵션 확인 / <strong class="mm_text-secondary text_num">5000</strong>개</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<span class="text_price">35000</span>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a class="mm_btn T=sm T=line" href="/product/option" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>옵션 확인 / <strong class="mm_text-secondary text_num">600</strong>개</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<span class="text_price">235000</span>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
					...
					<!-- (D) 승인 상태를 '승인 요청'으로 선택하여 검색할 경우 노출 합니다. -->
					<!-- 승인 상태 변경 -->
										...
										<td colspan="3">
											<div class="mm_btn_box">
												<div class="mm_inline">
													...
													<a class="mm_btn" href="/product/confirm/reject-form" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>반려</b></a>
												</div>
											</div>
										</td>
									</tr>
