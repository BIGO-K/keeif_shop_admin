			...
			<div class="mm_page-content">
				...
				<div class="mm_container">
					...
					<div class="mm_form_box">
						...
						<div class="mm_note">
							<ul>
								<li>진열 상태일 경우 쇼핑몰 프론트에 정상 노출되며, 재고가 0일 경우 품절 상태로 자동 변경됩니다.</li>
								<li>미진열 상태일 경우 쇼핑몰 프론트에 노출되지 않습니다.</li>
								<li>품절 상태일 경우 쇼핑몰 프론트에 [SOLD OUT] 상태로 노출됩니다.</li>
								<li>품절 상태 변경 후 90일 경과 시 미진열 상태로 자동 변경됩니다.</li>
								<li>품절 상태 변경 후 재고가 생길 경우 진열 상태로 자동 변경됩니다.</li>
								<li>선택된 상품 일괄 변경은 목록의 같은 페이지에 있는 상품만 가능합니다.</li>
							</ul>
						</div>
						<!-- // 유의사항 -->
					</div>
									...
									<td colspan="3">
										<div class="mm_form_mix-linked">
											<div class="mm_form-file">
												...
												<label>
													<input type="file" accept=".xlsx, .xls" data-file="{ '_fileName': 'soldout_product' }">
													<span class="text_path"></span>
													<span class="mm_btn T=line T=light text_label">파일첨부</span>
												</label>
											</div>
											<a class="btn_sample" href="#" download="soldout_product.xls"><b>샘플다운받기</b></a>
										...
										<div class="mm_note T=bottom">
											<ul>
												<li><strong>soldout_product 파일명만 업로드가 가능</strong>합니다. (xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가)</li>
