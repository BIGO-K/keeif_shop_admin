					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<ul class="mm_table-status">
										<li>주문 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
										<!-- (D) 주문 상태를 결제 완료, 배송 준비 중, 배송 지연으로 검색 했을 경우 노출합니다. -->
										<li>배송 출발 준수일 초과 주문 수<a href="#"><b class="mm_text-secondary"><strong class="text_num">0</strong>건</b></a></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
