				...
				<div class="mm_container">
					...
					<div class="mm_tab_menu">
						...
						<ul>
							...
							<li>
								<button type="button">
									<b>교환 신청<strong class="mm_text-secondary">(<span class="text_num">10</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>교환 회수 완료<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>교환 보류<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>교환 확정<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>교환 철회<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
						</ul>
					</div>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="mm_table-item">
													<a href="#" target="_blank" title="새 창 열림"><b>123450</b></a>
												</div>
											</td>
											<td>
												<div class="mm_table-item">
									...
									<tr>
										...
										<td colspan="3">
											<!--
												...
												교환 신청: 교환 회수 완료, 교환 철회
												교환 회수 완료: 교환 확정, 반품 전환, 교환 보류, 교환 철회
												교환 보류: 교환 확정, 반품 전환, 교환 철회
											-->
											<div class="mm_btn_box">
												<div class="mm_inline">
