								...
								<tr>
									...
									<td colspan="7">
										...
										<div class="mm_form-textarea">
											...
											<label>
												<textarea class="textfield" data-text></textarea><i class="bg_text"></i>
												<span class="text_placeholder mm_ir-blind">고객 관련 검색어를 입력해 주세요.</span>
											</label>
										</div>
										<div class="mm_note">
											<ul>
										...
										<tr>
											<td class="S=table-fixed">
												<div class="mm_table-item">
													<div class="mm_btn_box">
														<div class="mm_inline">
															<a class="mm_btn T=sm" href="/cs/notify/register" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>등록</b></a>
														</div>
													</div>
												</div>
											</td>
