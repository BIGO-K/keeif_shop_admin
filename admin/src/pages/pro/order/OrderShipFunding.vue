			...
			<div class="mm_page-content">
				...
				<div class="mm_container">
					...
					<div class="mm_tab_menu">
						...
						<ul>
							<li>
								<button type="button" class="S=tab-on" title="선택됨">
									<b>전체<strong class="mm_text-secondary">(<span class="text_num">1234</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>입금 대기<strong class="mm_text-secondary">(<span class="text_num">10</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>결제 완료<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>배송 준비 중<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>배송 중<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>배송 완료<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>구매 확정<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>배송 지연<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
						</ul>
					</div>
					...
					<div class="mm_search">
									...
									<td colspan="7">
										...
										<div class="mm_form-textarea">
											...
											<label>
												...
												<span class="text_placeholder mm_ir-blind">주문 관련 검색어를 입력해 주세요.</span>
											</label>
										</div>
										<div class="mm_note">
											<ul>
											...
											<ul>
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-category" data-radio checked>
														<b class="mm_block">
												...
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-category" data-radio>
														<b class="mm_block">
															<i class="ico_form-radio"></i>
						...
						<div class="mm_note">
							<ul>
								<li>기간 검색은 최대 3개월 범위로 검색이 가능합니다.</li>
							</ul>
						</div>
						<div class="mm_btn_box">
							<div class="mm_inline">
					...
					<div class="mm_table_box">
						...
						<div class="mm_table_box-caption">
							<div class="mm_lside">
								<ul class="mm_table-status">
									<li>주문 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									<!-- (D) 주문 상태를 결제 완료, 배송 준비 중, 배송 지연으로 검색 했을 경우 노출합니다. -->
									<li>배송 출발 준수일 초과 주문 수<a href="#"><b class="mm_text-secondary"><strong class="text_num">2</strong>건</b></a></li>
								</ul>
							</div>
							<div class="mm_rside">
						...
						<div class="mm_table_box-unit">
							<div class="mm_lside">
								<div class="mm_btn_box">
									<div class="mm_inline">
										<!-- (D) 송장 수정은 주문 상태를 배송 중으로 검색 했을 경우 노출합니다. -->
										<a class="mm_btn" href="/order/invoice-modify" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>송장 수정</b></a>
									</div>
								</div>
							</div>
							<div class="mm_rside">
								<div class="mm_btn_box">
									<div class="mm_inline">
										<!-- (D) 택배사 코드표는 주문 상태를 배송 준비 중으로 검색 했을 경우 노출합니다. -->
										<a class="mm_btn T=line T=light btn_code" href="/order/ship/code" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>택배사 코드표</b><i class="ico_ship"></i></a>
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td class="S=table-fixed">
												<div class="mm_table-item">
													<a href="/pro/order/detail/" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>123123123</b></a>
												</div>
											</td>
											<td class="S=table-fixed">
												<div class="mm_table-item"></div>
											</td>
											<td class="S=table-fixed">
												<div class="mm_table-item">
													1
											...
											<td>
												<div class="mm_table-item">
													<a href="/seller-info" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>셀러 A</b></a>
												</div>
											</td>
											<td>
												<div class="mm_table-item">
										...
										<tr>
											...
											<td class="S=table-fixed">
												<div class="mm_table-item">
													<a href="/pro/order/detail/" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>456456456</b></a>
												</div>
											</td>
											<td class="S=table-fixed">
												<div class="mm_table-item">
										...
										<tr>
											...
											<td>
												<div class="mm_table-item">
													<a href="#" target="_blank" title="새 창 열림"><b>1234567</b></a>
												</div>
											</td>
											<td>
												<div class="mm_table-item">
													(13487) 경기도 성남시 분당구 판교로 242 (삼평동) 판교디지털센터 C동 401호
												</div>
											</td>
											<td>
												<div class="mm_table-item">
						...
						<div class="mm_note">
							<ul>
								<li><strong>고객 결제 완료일 + 2일</strong>이 배송 출발 준수일로 노출됩니다. (영업일 기준)</li>
								<li>배송 출발 준수일이 지나도 배송 시작이 되지 않을 경우 <strong>배송 지연 패널티</strong>가 적용됩니다.</li>
							</ul>
						</div>
					</div>
					<!-- // 테이블영역 -->

					<!-- (D) 주문 상태를 배송 준비 중으로 검색 했을 경우 노출합니다. -->
					<!-- 송장번호 관리 -->
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="3">
											...
											<div class="mm_note T=bottom">
												<ul>
													<li>계약 코드 항목은 배송정책 등록 시 입력한 <strong>배송지명만 입력</strong>해주세요.</li>
													<li>xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가합니다.</li>
													<li>파일 지정 후 업로드 버튼 클릭 시 발송 처리됩니다.</li>
												</ul>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td colspan="3">
											<div class="mm_btn_box">
												<div class="mm_inline">
													<a class="mm_btn T=line" href="/order/ship/invoice" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>굿스플로 송장출력</b></a>
												</div>
											</div>
										</td>
									</tr>
					...
					<div class="mm_form_box">
							...
							<table>
								<tbody>
									...
									<tr>
										...
										<td colspan="3">
											<!--
												(D) 주문 상태 검색에 따라 버튼을 노출합니다.
												입금 대기: 결제 완료, 주문 취소
												결제 완료: 배송 준비 중, 주문 취소
												배송 준비 중: 발송 처리, 품절 처리, 예약 배송, 주문 취소
												배송 중: 배송 완료, 반품 신청, 교환 신청
												배송 완료: 구매 확정, 반품 신청, 교환 신청
												구매 확정: 반품 신청, 교환 신청
												배송 지연: 발송 처리, 품절 처리, 주문 취소
											-->
											<div class="mm_btn_box">
												<div class="mm_inline">
													<button type="button" class="mm_btn">
						...
						<div class="mm_note">
							<ul>
								...
								<li>주문 취소 시 바로 <strong>취소 완료</strong> 처리됩니다.</li>
								<li>입금 대기 상태인 주문의 상태 변경은 주문 단위로만 가능합니다.</li>
								<li>주문 내 일부 상품만 선택하여도 해당 주문의 모든 상품이 선택됩니다.</li>
							</ul>
						</div>
					</div>
					<!-- // 주문 상태 변경 -->
