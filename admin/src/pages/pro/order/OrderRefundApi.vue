						...
						<ul>
							<li>
								<button type="button" class="S=tab-on" title="선택됨">
									<b>환불 신청<strong class="mm_text-secondary">(<span class="text_num">1234</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>환불 실패<strong class="mm_text-secondary">(<span class="text_num">10</span>)</strong></b>
								</button>
							</li>
							<li>
								<button type="button">
									<b>환불 완료<strong class="mm_text-secondary">(<span class="text_num">23</span>)</strong></b>
								</button>
							</li>
						</ul>
					</div>
										...
										<tr>
											<td class="S=table-fixed">
												<div class="mm_table-item">
													<div class="mm_btn_box">
														<div class="mm_inline">
															<a class="mm_btn" href="/order/refund/complete" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>수동 환불 완료</b></a>
														</div>
													</div>
												</div>
											</td>
										...
										<tr>
											<td class="S=table-fixed">
												<div class="mm_table-item">
													<div class="mm_btn_box">
														<div class="mm_inline">
															<a class="mm_btn T=line" href="/order/refund/detail" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>수동 환불 완료 내역</b></a>
														</div>
													</div>
												</div>
											</td>
