											...
											<ul>
												...
												<li>
													<label class="mm_form-check">
														...
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">자사몰</span>
														</b>
													</label>
												</li>
												<li>
													<label class="mm_form-check">
														...
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">제휴사1</span>
														</b>
													</label>
												</li>
												<li>
													<label class="mm_form-check">
														...
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">제휴사2</span>
														</b>
													</label>
												</li>
											</ul>
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td class="S=table-fixed">
												<div class="mm_table-item">
													<a href="/pro/order/detail/api" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>123123123</b></a>
												</div>
											</td>
											<td class="S=table-fixed">
										...
										<tr>
											...
											<td class="S=table-fixed">
												<div class="mm_table-item">
													<a href="/pro/order/detail/api" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>456456456</b></a>
												</div>
											</td>
											<td class="S=table-fixed">
												<div class="mm_table-item">
