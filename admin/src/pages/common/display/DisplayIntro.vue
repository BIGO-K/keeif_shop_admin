		...
		<template #content>
			<div class="mm_page-content">
				...
				<div class="mm_container">
					...
					<div class="mm_note">
						<ul>
							<li>앱 인트로 이미지는 <strong>1개의 이미지만 노출</strong>되며, 새로운 이미지를 노출 상태로 등록할 경우 기존 이미지는 미노출 상태로 자동 변경됩니다.</li>
							<li>노출되는 앱 인트로 이미지가 없을 경우 앱 로드 시 흰색 화면이 노출됩니다.</li>
						</ul>
					</div>
					<!-- // 유의사항 -->
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="intro/register" data-href="{ '_type': 'link' }"><b>앱인트로 이미지 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>이미지 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
									<div class="mm_note">
									...
									<table>
										<thead>
											<tr>
												...
												<th scope="col">
													<div class="mm_table-item">
														<span>앱인트로 이미지</span><button type="button" class="btn_preview-toggle" title="이미지 미리보기 켜기">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="intro/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="intro/register" data-href="{ '_type': 'link' }"><b>앱인트로 이미지 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>이미지 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
									<div class="mm_note">
										<p><i class="ico_image-show"></i> 아이콘 클릭 시 이미지가 노출됩니다.</p>
									</div>
