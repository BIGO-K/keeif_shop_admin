	...
	<layout>
		<template #content>
			<div class="mm_page-content">
					...
					<div class="mm_form">
						<table>
							<tbody>
								...
								<tr>
									<th scope="row">
										<b>Mobile/PC 노출 여부<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
											...
											<ul>
												<li>
													<label class="mm_form-check">
														<input type="checkbox" name="dev_check-exposure" data-check="{ 'syncer': '.mm_syncer-mobile-popup, .mm_syncer-pc-merge', 'onChange': 'mobileOff' }" checked>
														<b class="mm_block">
												...
												<li>
													<label class="mm_form-check">
														<input type="checkbox" name="dev_check-exposure" data-check="{ 'syncer': '.mm_syncer-pc-popup' }" checked>
														<b class="mm_block">
															<i class="ico_form-check"></i>
								...
								<tr class="mm_syncer-mobile-popup">
									<th scope="row">
										<b>팝업 (Mobile)<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
										<div class="mm_form_mix-image">
											...
											<div class="mm_note T=bottom">
												<ul>
													...
													<li>권장 사이즈는 W 614px * H 700px 이며, JPG/PNG 형식의 파일만 등록이 가능합니다.</li>
								...
								<tr class="mm_syncer-pc-popup">
									<th scope="row">
										<b>팝업 (PC)<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
										<div class="mm_syncer-pc-merge">
											<label class="mm_form-check">
												<input type="checkbox" data-check="{ 'desyncer': '.mm_desyncer-pc-image' }" checked>
												<b class="mm_block">
													<i class="ico_form-check"></i>
										...
										<div class="mm_desyncer-pc-image">
											<div class="mm_form_mix-image">
												<div class="mm_form-image">
													<div class="mm_form-image-preview"></div>
													<label>
												...
												<div class="mm_note T=bottom">
													<ul>
														<li>대체 텍스트는 화면에 노출되지 않으며 이미지를 설명하는 내용을 작성해 주세요.</li>
														<li>권장 사이즈는 W 400px * H 456px 이며, JPG/PNG 형식의 파일만 등록이 가능합니다.</li>
														<li>이미지 최대 용량은 2MB를 초과할 수 없습니다.</li>
													</ul>
												</div>
											</div>
				...
				<!--
					<script>
					// mobile/pc 노출여부 pc만 선택 시 pc 이미지 등록 영역만 노출
					function mobileOff() {

					mm.form.value('.mm_syncer-pc-merge .mm_form-check', this.checked);
