					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="product-banner/register" data-href="{ '_type': 'link' }"><b>공통배너 등록하기</b><i class="ico_register"></i></a>
								</div>
							</div>
							<!-- // 테이블상단 -->
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/display/product-banner/coverage/product" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>상품</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="product-banner/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/display/product-banner/coverage/category" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>카테고리</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/display/product-banner/coverage/brand" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>브랜드</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
