											...
											<ul>
												<li>
													<label class="mm_form-check">
														<input type="checkbox" name="dev_check-category" data-check="{ '_type': 'check_all' }" checked>
														<b class="mm_block">
												...
												<li>
													<label class="mm_form-check">
														<input type="checkbox" name="dev_check-category" data-check>
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">NEW</span>
														</b>
													</label>
												</li>
												<li>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="webzine/register" data-href="{ '_type': 'link' }"><b>쇼케이스 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>쇼케이스 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="webzine/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="webzine/register" data-href="{ '_type': 'link' }"><b>쇼케이스 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>쇼케이스 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
