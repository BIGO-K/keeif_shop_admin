			...
			<div class="mm_page-content">
				...
				<div class="mm_container">
					...
					<div class="mm_form_box">
												...
												<ul>
													<li>
														<label class="mm_form-radio">
															<input type="radio" name="dev_radio-gnb" data-radio checked>
															<b class="mm_block">
													...
													<li>
														<label class="mm_form-radio">
															<input type="radio" name="dev_radio-gnb" data-radio>
															<b class="mm_block">
																<i class="ico_form-radio"></i>
						...
						<div class="mm_note">
							<ul>
								<li>[저장하기] 버튼 클릭 시 <strong>프론트에 즉시 반영</strong>됩니다.</li>
							</ul>
						</div>
						<!-- // 유의사항 -->
					</div>
											...
											<ul>
												<li>
													<label class="mm_form-check">
														<input type="checkbox" name="dev_check-progress" data-check="{ '_type': 'check_all' }" checked>
														<b class="mm_block">
												...
												<li>
													<label class="mm_form-check">
														<input type="checkbox" name="dev_check-progress" data-check>
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">진행 예정</span>
														</b>
													</label>
												</li>
												<li>
												...
												<li>
													<label class="mm_form-check">
														...
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">응모 마감</span>
														</b>
													</label>
												</li>
												<li>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="raffle/register" data-href="{ '_type': 'link' }"><b>래플 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>래플 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
									<div class="mm_note">
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a class="mm_btn T=sm T=line T=light" href="/display/sub/raffle/period" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>기간 보기</b></a>
													</div>
												</td>
												...
												<td>
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																<a class="mm_btn T=sm T=line T=light" href="/display/sub/raffle/apply" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>응모회원</b></a>
																<button type="button" class="mm_btn T=sm T=line">
																	<b>삭제</b>
																</button>
																<a class="mm_btn T=sm" href="raffle/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="raffle/register" data-href="{ '_type': 'link' }"><b>래플 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>래플 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
									<div class="mm_note">
										<p><i class="ico_image-show"></i> 아이콘 클릭 시 이미지가 노출됩니다.</p>
									</div>
