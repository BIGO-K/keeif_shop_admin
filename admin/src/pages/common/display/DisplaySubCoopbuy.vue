					...
					<div class="mm_form_box">
						...
						<div class="mm_note">
							<ul>
								...
								<li>진행중인 공동구매가 있을 경우 미노출 상태로 변경이 불가합니다.</li>
							</ul>
						</div>
						<!-- // 유의사항 -->
					</div>
											...
											<ul>
												...
												<li>
													<label class="mm_form-check">
														...
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">진행중</span>
														</b>
													</label>
												</li>
												<li>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="coopbuy/register" data-href="{ '_type': 'link' }"><b>공동구매 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>공동구매 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
									<div class="mm_note">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="coopbuy/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																<a class="mm_btn T=sm T=line T=light" href="/display/sub/coopbuy/apply" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>신청회원</b></a>
																<a class="mm_btn T=sm" href="coopbuy/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
