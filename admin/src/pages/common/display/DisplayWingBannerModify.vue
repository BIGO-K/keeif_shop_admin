					...
					<div class="mm_form">
						<table>
							<tbody>
								...
								<tr>
									<th scope="row">
										<b>링크 URL<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
										<div class="mm_form-text">
											<button type="button" class="btn_text-clear">
								...
								<tr>
									<th scope="row">
										<b>우측배너 (PC)<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
										<div class="mm_form_mix-image">
											...
											<div class="mm_note T=bottom">
												<ul>
													...
													<li>권장 사이즈는 W 100px * H 220px 이며, JPG/PNG 형식의 파일만 등록이 가능합니다.</li>
								...
								<tr>
									<th scope="row">
										<b>빅배너 (PC)<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
										<div class="mm_form_mix-image">
											<div class="mm_form-image">
											...
											<div class="mm_note T=bottom">
												<ul>
													<li>대체 텍스트는 화면에 노출되지 않으며 이미지를 설명하는 내용을 작성해 주세요.</li>
													<li>권장 사이즈는 W 1488px * H 580px 이며, JPG/PNG 형식의 파일만 등록이 가능합니다.</li>
													<li>이미지 최대 용량은 2MB를 초과할 수 없습니다.</li>
												</ul>
											</div>
										</div>
