					...
					<div class="mm_form">
						<table>
							<tbody>
								...
								<tr>
									<th scope="row">
										<b>공동구매 진행기간<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
								...
								<tr>
									<th scope="row">
										<b>목표 구매 수<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
								...
								<tr>
									<th scope="row">
										<b>공동구매 상품<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
								...
								<tr>
									<th scope="row">
										<b>공동구매 쿠폰<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
