				...
				<div class="mm_container">
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_note">
								<ul>
									<li>목록에 있는 상품은 EP 쿠폰 적용 대상에서 제외됩니다.</li>
									...
									<td colspan="3">
										<div class="mm_form_mix-linked">
											<div class="mm_form-file">
												...
												<label>
													<input type="file" accept=".xlsx, .xls" data-file="{ '_fileName': 'exception_ep' }">
													<span class="text_path"></span>
													<span class="mm_btn T=line T=light text_label">파일첨부</span>
												</label>
											</div>
											<a class="btn_sample" href="#" download="exception_ep.xls"><b>샘플다운받기</b></a>
										...
										<div class="mm_note T=bottom">
											<ul>
												<li><strong>exception_ep 파일명만 업로드가 가능</strong>합니다. (xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가)</li>
