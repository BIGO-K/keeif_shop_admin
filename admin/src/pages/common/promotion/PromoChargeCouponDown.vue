		...
		<template #content>
			<div class="mm_page-content">
				...
				<div class="mm_container">
					...
					<div class="mm_note">
						<ul>
							<li>셀러가 등록한 상품에 적용된 다운로드 쿠폰 할인 내역이 노출됩니다.</li>
							<li>수정 및 삭제는 최고 관리자를 통해서만 가능합니다.</li>
						</ul>
					</div>
					<!-- // 유의사항 -->
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<ul class="mm_table-status">
										<li>셀러 부담 할인 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														2020-04-20 11:11:11 ~ 2020-04-20 11:11:11
													</div>
												</td>
												<td>
													<div class="mm_table-item">
					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<ul class="mm_table-status">
										<li>셀러 부담 할인 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
