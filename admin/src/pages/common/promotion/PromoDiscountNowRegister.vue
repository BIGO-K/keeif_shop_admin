										...
										<td colspan="3">
											<div class="mm_form_mix-linked">
												<div class="mm_form-file">
													...
													<label>
														<input type="file" accept=".zip" data-file="{ '_fileName': 'discount_immediately_product' }">
											...
											<div class="mm_note T=bottom">
												<ul>
													<li><strong>discount_immediately_product 파일명만 업로드가 가능</strong>합니다. (xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가)</li>
