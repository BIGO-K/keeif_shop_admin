				...
				<div class="mm_container">
									...
									<td colspan="7">
										<div class="mm_radio-list">
											<ul>
												...
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-coupon" data-radio>
														<b class="mm_block">
															<i class="ico_form-radio"></i>
									...
									<td colspan="3">
										<div class="mm_radio-list">
											<ul>
												...
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-custom" data-radio>
														<b class="mm_block">
															<i class="ico_form-radio"></i>
					...
					<div class="mm_table_box">
						...
						<div class="mm_table_box-caption">
							<div class="mm_lside">
								<a class="mm_btn T=line T=secondary btn_register" href="/promotion/coupon/download/timedeal/register" data-href="{ '_type': 'link' }"><b>다운로드 쿠폰 등록하기</b><i class="ico_register"></i></a>
								<ul class="mm_table-status">
									<li>쿠폰 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
								</ul>
							</div>
							<div class="mm_rside">
									...
									<tbody>
										<tr>
											...
											<td class="T=table-left">
												<div class="mm_table-item">
													<a href="/promotion/coupon/download/detail" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>2022 새해맞이 쿠폰</b></a>
												</div>
											</td>
											<td>
												<div class="mm_table-item">
											...
											<td>
												<div class="mm_table-item">
													<a href="/promotion/coupon/history" data-href="{ '_type': 'popup' }" title="새 창 열림"><b class="text_num">1000</b></a>
												</div>
											</td>
											<td>
												<div class="mm_table-item">
											...
											<td>
												<div class="mm_table-item">
													2020-06-01 12:23:12 ~ 2020-06-04 17:13:22
												</div>
											</td>
											<td>
												<div class="mm_table-item">
												...
												<div class="mm_table-item">
													<div class="mm_btn_box">
														<div class="mm_inline">
															...
															<a class="mm_btn T=sm" href="/promotion/coupon/download/timedeal/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
														</div>
													</div>
												</div>
											</td>
												...
												<div class="mm_table-item">
													<div class="mm_btn_box">
														<div class="mm_inline">
															...
															<a class="mm_btn T=sm" href="/promotion/coupon/download/timedeal/modify-none" data-href="{ '_type': 'link' }"><b>수정</b></a>
														</div>
													</div>
												</div>
											</td>
