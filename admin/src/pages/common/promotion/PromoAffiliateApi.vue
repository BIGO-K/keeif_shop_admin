						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-unit">
								<div class="mm_lside">
									<div class="mm_btn_box">
										<div class="mm_inline">
											<a class="mm_btn T=line T=secondary" href="/promotion/Affiliate/api/search" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>상품 추가</b></a>
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a class="mm_btn T=sm T=line T=light" href="/promotion/Affiliate/api/list" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>적용 제휴사 보기</b></a>
													</div>
												</td>
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="/promotion/Affiliate/api/modify" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
							...
							<div class="mm_note">
								<ul>
									<li>1차 쿠폰가는 해당 상품에 설정된 1차 쿠폰 할인율 중 <strong>셀러 부담 할인율</strong>만 계산된 가격이 기준입니다.</li>
									<li>기준 가격으로 설정한 할인율이 계산되어 지정한 제휴사에 연동됩니다.</li>
									<li>목록의 같은 페이지에 노출되고 있는 항목에 대해서만 [선택삭제]가 가능합니다.</li>
								</ul>
							</div>
							<!-- // 유의사항 -->
						</div>
									...
									<td colspan="3">
										<div class="mm_form_mix-linked">
											<div class="mm_form-file">
												...
												<label>
													<input type="file" accept=".xlsx, .xls" data-file="{ '_fileName': 'discount_alliance' }">
													<span class="text_path"></span>
													<span class="mm_btn T=line T=light text_label">파일첨부</span>
												</label>
											</div>
											<a class="btn_sample" href="#" download="discount_alliance.xls"><b>샘플다운받기</b></a>
										...
										<div class="mm_note T=bottom">
											<ul>
												<li><strong>discount_alliance 파일명만 업로드가 가능</strong>합니다. (xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가)</li>
