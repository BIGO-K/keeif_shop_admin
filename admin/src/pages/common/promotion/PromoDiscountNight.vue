					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="night/register" data-href="{ '_type': 'link' }"><b>심야 할인 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>할인 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
										...
										<tbody>
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<a href="/promotion/discount/night/detail" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>2022 대박특가</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="night/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="night/register" data-href="{ '_type': 'link' }"><b>심야 할인 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>할인 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
