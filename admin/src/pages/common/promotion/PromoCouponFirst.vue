											...
											<ul>
												...
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">사용 대기</span>
														</b>
													</label>
												</li>
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">사용 중</span>
														</b>
													</label>
												</li>
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">사용 종료</span>
														</b>
													</label>
												</li>
											</ul>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="coupon-first/register" data-href="{ '_type': 'link' }"><b>1차 쿠폰 등록하기</b><i class="ico_register"></i></a>
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														2020-06-01 12:00:00 ~ 2020-06-04 17:00:00
													</div>
												</td>
												<td>
													<div class="mm_table-item">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="coupon-first/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
