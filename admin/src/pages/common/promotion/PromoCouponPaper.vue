					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="paper/register" data-href="{ '_type': 'link' }"><b>페이퍼 쿠폰 등록하기</b><i class="ico_register"></i></a>
										...
										<tbody>
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<a href="/promotion/coupon/paper/detail" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>2022 새해맞이 쿠폰</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<a href="/promotion/coupon/paper/history" data-href="{ '_type': 'popup' }" title="새 창 열림"><b class="text_num">1000</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<a class="mm_btn T=sm T=line T=light" href="/promotion/coupon/paper/certify" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>등록/관리</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="paper/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="paper/modify-none" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="paper/register" data-href="{ '_type': 'link' }"><b>페이퍼 쿠폰 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>쿠폰 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
