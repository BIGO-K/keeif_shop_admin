						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<ul class="mm_table-status">
										<li>셀러 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
							...
							<div class="mm_table_box-unit">
								<div class="mm_lside">
									<div class="mm_btn_box">
										<div class="mm_inline">
											<a class="mm_btn T=line T=secondary" href="/promotion/except/seller/search" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>셀러 추가</b></a>
											<button type="button" class="mm_btn T=line">
												<b>선택 삭제</b>
											</button>
											<a class="mm_btn" href="/promotion/except/seller/modify" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>선택 수정</b></a>
										</div>
									</div>
								</div>
								<div class="mm_rside">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="/promotion/except/seller/modify" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
							...
							<div class="mm_note">
								<ul>
									<li>목록에 있는 셀러의 상품은 EP 노출 대상에서 제외됩니다.</li>
					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<ul class="mm_table-status">
										<li>셀러 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
									...
									<td colspan="3">
										<div class="mm_form_mix-linked">
											<div class="mm_form-file">
												...
												<label>
													<input type="file" accept=".xlsx, .xls" data-file="{ '_fileName': 'exception_seller_ep_exposure' }">
													<span class="text_path"></span>
													<span class="mm_btn T=line T=light text_label">파일첨부</span>
												</label>
											</div>
											<a class="btn_sample" href="#" download="exception_seller_ep_exposure.xls"><b>샘플다운받기</b></a>
										...
										<div class="mm_note T=bottom">
											<ul>
												<li><strong>exception_seller_ep_exposure 파일명만 업로드가 가능</strong>합니다. (xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가)</li>
