											...
											<ul>
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-search" data-radio checked>
														<b class="mm_block">
												...
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-search" data-radio>
														<b class="mm_block">
															<i class="ico_form-radio"></i>
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-unit">
								<div class="mm_lside">
									<div class="mm_btn_box">
										<div class="mm_inline">
											<a class="mm_btn" href="/calc/data/modify" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>정산 데이터 일괄 수정</b></a>
										</div>
									</div>
								</div>
								<div class="mm_rside">
									...
									<table>
										<thead>
											<tr>
												...
												<th scope="col">
													<div class="mm_table-item">
														변경 다운로드 쿠폰<br>자사 부담률
													</div>
												</th>
												<th scope="col">
													<div class="mm_table-item">
														변경 다운로드 쿠폰<br>셀러 부담률
													</div>
												</th>
												<th scope="col">
													<div class="mm_table-item">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														2022-12-22 12:03:22 ~ 2022-12-23 12:33:42
													</div>
												</td>
												<td>
													<div class="mm_table-item">
