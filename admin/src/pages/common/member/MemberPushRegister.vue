					...
					<div class="mm_form">
						<table>
							<tbody>
								...
								<tr>
									<th scope="row">
										<b>푸시 제목<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
								...
								<tr>
									<th scope="row">
										<b>발송일시<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
								...
								<tr>
									<th scope="row">
										<b>푸시 내용<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
										<div class="mm_form-textarea">
											...
											<label>
												<textarea class="textfield" data-text="{ '_resizeMin': 6, '_byte': 100 }"></textarea><i class="bg_text"></i>
								...
								<tr>
									<th scope="row">
										<b>푸시 링크<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
										<div class="mm_form-text">
											<button type="button" class="btn_text-clear">
										...
										<div class="mm_note">
											<p class="mm_text-primary">
												URL 등록 시, 전체 URL을 입력해 주세요 예) m.solution.co.kr/product/1234565
											</p>
										</div>
									</td>
								</tr>
										...
										<div class="mm_form_mix-image">
											...
											<div class="mm_note T=bottom">
												<ul>
													...
													<li>권장 사이즈는 W 800px * H 400px 이며, JPG/PNG 형식의 파일만 등록이 가능합니다.</li>
