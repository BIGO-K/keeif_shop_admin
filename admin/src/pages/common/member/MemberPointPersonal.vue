			...
			<div class="mm_page-content">
				<div class="mm_container">
					...
					<div class="mm_search">
						...
						<div class="mm_note">
							<ul>
								<li>키워드를 검색할 때, 키워드 전체를 입력해주세요. 부분입력 시 검색이 정상적으로 진행되지 않습니다. 예) hong1 검색 시, hong(검색안됨) hong1(검색됨)</li>
								<li>적립금 검색 시, 각 영역별로 9자리의 숫자까지만 입력이 가능합니다.</li>
							</ul>
						</div>
						<div class="mm_btn_box">
							<div class="mm_inline">
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<span class="text_num">4000</span>원
													</div>
												</td>
												<td>
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																<a class="mm_btn T=sm T=line" href="/member/point/personal/state" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>적립금 관리</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<span class="text_num">15200</span>원
													</div>
												</td>
												<td>
													<div class="mm_table-item">
