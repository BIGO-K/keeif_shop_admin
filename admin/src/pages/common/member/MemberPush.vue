			...
			<div class="mm_page-content">
				<div class="mm_container">
					...
					<div class="mm_search">
						...
						<div class="mm_note">
							<ul>
								<li>기간 검색은 등록일자에 대한 검색이며, 최대 1년 단위로 검색하시기 바랍니다.</li>
							</ul>
						</div>
						<div class="mm_btn_box">
							<div class="mm_inline">
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="push/register" data-href="{ '_type': 'link' }"><b>푸시 등록하기</b><i class="ico_register"></i></a>
									<div class="mm_note">
									...
									<table>
										<thead>
											<tr>
												...
												<th scope="col">
													<div class="mm_table-item">
														<span>이미지</span><button type="button" class="btn_preview-toggle" title="이미지 미리보기 켜기">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="#" target="_blank" title="새 창 열림"><b>https://m.solution.co.kr/event/promotion/125</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<div>성공: <span class="mm_text-tertiary text_num">10670</span> / 실패: <span class="mm_text-secondary text_num">5000</span></div>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																<button type="button" class="mm_btn T=sm T=line T=secondary">
																	<b>테스트 푸시 발송</b>
																</button>
																<button type="button" class="mm_btn T=sm T=line">
																	<b>삭제</b>
																</button>
																<a class="mm_btn T=sm" href="push/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														푸시 제목 입니다.푸시 제목 입니다.푸시 제목 입니다.푸시 제목 입니다.푸시 제목 입니다.
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																<a class="mm_btn T=sm T=line" href="push/detail" data-href="{ '_type': 'link' }"><b>내용 확인</b></a>
															</div>
														</div>
													</div>
												</td>
					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="/member/push/register" data-href="{ '_type': 'link' }"><b>푸시 등록하기</b><i class="ico_register"></i></a>
									<div class="mm_note">
										<p><i class="ico_image-show"></i> 아이콘 클릭 시 이미지가 노출됩니다.</p>
									</div>
								</div>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								...
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="push/tester" data-href="{ '_type': 'link' }"><b>푸시 테스터 등록하기</b><i class="ico_register"></i></a>
								</div>
							</div>
							<div class="mm_table_box-unit">
								<div class="mm_lside">
					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								...
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="/member/push/tester" data-href="{ '_type': 'link' }"><b>푸시 테스터 등록하기</b><i class="ico_register"></i></a>
								</div>
							</div>
							<!-- // 테이블상단 -->
