				...
				<div class="mm_container">
											...
											<ul>
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-send" data-radio checked>
														<b class="mm_block">
												...
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-send" data-radio>
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">이메일</span>
														</b>
													</label>
												</li>
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">SMS</span>
														</b>
													</label>
												</li>
											</ul>
											...
											<ul>
												...
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">발송완료</span>
														</b>
													</label>
												</li>
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">발송 중</span>
														</b>
													</label>
												</li>
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">발송 예정</span>
														</b>
													</label>
												</li>
											</ul>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<ul class="mm_table-status">
										<li>이메일/SMS 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/member/inform/history/detail/mail" data-href="{ '_type': 'popup' }"><b>이메일 발송3</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="history/mail/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/member/inform/history/detail/sms" data-href="{ '_type': 'popup' }"><b>SMS 알림 발송</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="history/sms/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/member/inform/history/detail/sms" data-href="{ '_type': 'popup' }"><b>등급 변경 안내 SMS</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<span class="text_num">123500</span>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/member/inform/history/detail/mail" data-href="{ '_type': 'popup' }"><b>등급 변경 안내 이메일</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
							...
							<div class="mm_note">
								<ul>
									<li>이메일/SMS 발송 내역을 확인 할 수 있습니다.</li>
									<li>발송완료 : 고객에게 발송이 완료된 상태 / 발송 중 : 현재 고객에게 발송이 진행 중인 상태 / 발송 예정 : 아직 고객에게 발송되지 않은 상태</li>
								</ul>
							</div>
							<!-- // 유의사항 -->
						</div>
					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<ul class="mm_table-status">
										<li>이메일/SMS 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
