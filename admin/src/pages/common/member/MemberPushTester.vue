					...
					<div class="mm_form">
						<table>
							<tbody>
								...
								<tr>
									<th scope="row">
										<b>테스터 아이디<i class="ico_required" title="필수입력"></i></b>
									</th>
									<td colspan="3">
										<div class="mm_form_mix-linked">
											<div class="mm_form-text T=sm">
												...
												<label>
													...
													<span class="text_placeholder mm_ir-blind">테스터 아이디</span>
												</label>
											</div>
								...
								<tr>
									...
									<td>
										<div class="mm_form-text">
											...
											<label>
												<input type="text" class="textfield" data-text><i class="bg_text"></i>
												<span class="text_placeholder">예) 갤럭시S22, 갤럭시노트9, 아이폰12</span>
											</label>
										</div>
									</td>
								</tr>
