		...
		<template #content>
			<div class="mm_page-content">
				...
				<div class="mm_container">
					...
					<div class="mm_note">
						<ul>
							<li>승인 완료된 체험단 후기는 프론트에 노출됩니다.</li>
						</ul>
					</div>
					<!-- // 안내문구 -->
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-unit">
								<div class="mm_lside">
									<div class="mm_btn_box">
										<div class="mm_inline">
											<!-- (D) 승인 상태가 승인 요청/반려 일 경우 승인 완료 버튼을 노출합니다. -->
											<button type="button" class="mm_btn">
												<b>승인 완료</b>
											</button>
											<!-- (D) 승인 상태가 승인 요청/승인 완료 일 경우 반려 버튼을 노출합니다. -->
											<button type="button" class="mm_btn">
												<b>반려</b>
											</button>
										</div>
										...
										<tbody>
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<a class="T=linebreak" href="reviewer/detail" data-href="{ '_type': 'link' }"><b>하이커 에어 백팩 후기</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<a class="T=linebreak" href="reviewer/detail" data-href="{ '_type': 'link' }"><b>아식스 젤 1090 후기</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<a class="T=linebreak" href="reviewer/detail" data-href="{ '_type': 'link' }"><b>첼시부츠 사용 후기</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
