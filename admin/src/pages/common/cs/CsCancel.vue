			...
			<div class="mm_page-content">
				...
				<div class="mm_container">
					...
					<div class="mm_search">
											...
											<ul>
												...
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">처리 완료</span>
														</b>
													</label>
												</li>
											</ul>
						...
						<div class="mm_note">
							<ul>
								<li>기간 검색은 신고일자에 대한 검색이며, 최대 1년 단위로 검색하시기 바랍니다.</li>
							</ul>
						</div>
						<div class="mm_btn_box">
							<div class="mm_inline">
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/pro/order/detail/" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>20000205878</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<span class="text_num">500</span>원
													</div>
												</td>
												<td class="T=table-left">
													<div class="mm_table-item">
														<p class="T=linebreak">
															<b>[테일러메이드]21SS 여성 옆선 배색 로고 큐롯 TWCUK6196-100</b>
														</p>
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<span class="text_num">600</span>원
													</div>
												</td>
												<td class="T=table-left">
													<div class="mm_table-item">
														<p class="T=linebreak">
															<b>DMAN DOMINIK 2 D211007 OFFWHITE/GREY</b>
														</p>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="mm_table-item">
														<span class="text_price">74900</span>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<span class="text_num">10770</span>원
													</div>
												</td>
												<td class="T=table-left">
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<span class="text_price">359000</span>
													</div>
												</td>
											</tr>
										</tbody>
					...
					<div class="mm_table_box">
						...
						<div class="mm_note">
							<ul>
								<li>재고 부족 등의 이유로 품절 사실을 안내 받으신 경우 상품 금액 3%를 적립금으로 보상해드리는 제도입니다.</li>
								<li><strong>결제 완료일로부터 품절 처리일 수 기준</strong>으로 계산되어 노출됩니다.</li>
							</ul>
						</div>
						<!-- // 안내문구 -->
					</div>
