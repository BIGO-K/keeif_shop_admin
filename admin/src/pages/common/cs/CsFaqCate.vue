					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="faq-category/register" data-href="{ '_type': 'link' }"><b>FAQ 분류 등록하기</b><i class="ico_register"></i></a>
								</div>
								<div class="mm_rside">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="faq-category/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
							...
							<div class="mm_note">
								<ul>
									<li>FAQ 수는 해당 1 DEPTH 분류에 등록되어 있는 FAQ 수가 노출됩니다. 등록된 FAQ가 있을 시 분류 삭제는 불가합니다.</li>
									<li>FAQ 분류 추가 시, 프론트 &#62; 고객센터 페이지에 FAQ 항목이 자동 추가되지 않습니다.</li>
								</ul>
							</div>
							<!-- // 안내문구 -->
						</div>
