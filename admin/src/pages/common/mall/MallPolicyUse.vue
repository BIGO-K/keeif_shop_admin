			...
			<div class="mm_page-content">
				<div class="mm_container">
					...
					<div class="mm_tab_menu">
						...
						<ul>
							<li><a class="S=tab-on" href="./use" data-href="{ '_type': 'link' }" title="선택됨"><b>이용약관</b></a></li>
							<li><a href="./privacy" data-href="{ '_type': 'link' }"><b>개인정보처리방침</b></a></li>
							<li><a href="./consent" data-href="{ '_type': 'link' }"><b>제 3자 정보제공동의</b></a></li>
							<li><a href="./youth" data-href="{ '_type': 'link' }"><b>청소년보호방침</b></a></li>
						</ul>
					</div>
					<!-- // 탭메뉴 -->
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="register" data-href="{ '_type': 'link' }"><b>이용약관 등록하기</b><i class="ico_register"></i></a>
								</div>
							</div>
										...
										<tbody>
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<a class="T=linebreak" href="/pro/mall/policy/use/detail" data-href="{ '_type': 'link' }"><b class="mm_text-ellipsis T=2line">이용약관 v2.0</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																<button type="button" class="mm_btn T=sm T=line" onclick="mm.bom.confirm('해당 약관을 삭제하시겠습니까?', sampleCallback);">
																	<b>삭제</b>
																</button>
																<a class="mm_btn T=sm" href="modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<a class="T=linebreak" href="use/detail" data-href="{ '_type': 'link' }"><b class="mm_text-ellipsis T=2line">이용약관 v2.0</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="/mall/policy/register" data-href="{ '_type': 'link' }"><b>이용약관 등록하기</b><i class="ico_register"></i></a>
								</div>
							</div>
							<!-- // 테이블상단 -->
...
<script setup lang="ts">
	// import Lnb from './components/MallLnb.vue';
