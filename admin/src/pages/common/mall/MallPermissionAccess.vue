				...
				<div class="mm_container">
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="./access/register" data-href="{ '_type': 'link' }"><b>접근 권한 등록하기</b><i class="ico_register"></i></a>
								</div>
							</div>
										...
										<tbody>
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<p class="T=linebreak">
															<b class="mm_text-ellipsis T=2line">웹디자인팀 접근 권한</b>
														</p>
													</div>
												</td>
												<td>
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="./access/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="/mall/permission/access/register" data-href="{ '_type': 'link' }"><b>접근 권한 등록하기</b><i class="ico_register"></i></a>
								</div>
							</div>
							<!-- // 테이블상단 -->
