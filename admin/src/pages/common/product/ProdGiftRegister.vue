						...
						<div class="mm_form">
							<table>
								<tbody>
									...
									<tr>
										<th scope="row">
											<b>사은품 명<i class="ico_required" title="필수입력"></i></b>
										</th>
										<td colspan="3">
									...
									<tr>
										<th scope="row">
											<b>사은품 이미지<i class="ico_required" title="필수입력"></i></b>
										</th>
										<td colspan="3">
									...
									<tr>
										<th scope="row">
											<b>수량 설정(재고)<i class="ico_required" title="필수입력"></i></b>
										</th>
										<td colspan="3">
									...
									<tr>
										<th scope="row">
											<b>지급 기준<i class="ico_required" title="필수입력"></i></b>
										</th>
										<td colspan="3">
																...
																<div class="mm_form_mix-linked">
																	<div class="mm_radio-list">
																		<ul>
																			<li>
																				<label class="mm_form-radio">
																					<input type="radio" name="dev_radio-condition" data-radio checked>
																					<b class="mm_block">
																						<i class="ico_form-radio"></i>
																						<span class="text_label">구매 시 지급</span>
																					</b>
																				</label>
																			</li>
																			<li>
																				<label class="mm_form-radio">
																					<input type="radio" name="dev_radio-condition" data-radio="{ 'syncer': '.mm_syncer-condition-price' }">
																					<b class="mm_block">
																						<i class="ico_form-radio"></i>
																						<span class="text_label">특정 금액 이상 구매 시 지급</span>
																					</b>
																				</label>
																			</li>
																		</ul>
																	</div>
																	<div class="mm_syncer-condition-price">
																		<div class="mm_form_mix-linked">
																			<div class="mm_form-text T=xs">
																				<button type="button" class="btn_text-clear">
																					<i class="ico_form-clear"></i><b class="mm_ir-blind">지우기</b>
															...
															<td>
																<label class="mm_form-check">
																	...
																	<b class="mm_block">
																		...
																		<span class="text_label">최초 1회만 지급</span>
																	</b>
																</label>
																<div class="mm_note">
																	<p>'최초 1회만 지급' 선택 시 회원은 상품 구매 횟수와 관계없이 본 사은품을 한 번만 지급받을 수 있습니다.</p>
																</div>
															</td>
														</tr>
													</tbody>
									...
									<tr>
										<th scope="row">
											<b>지급 조건<i class="ico_required" title="필수입력"></i></b>
										</th>
										<td colspan="3">
											<div class="mm_form-text">
												<button type="button" class="btn_text-clear">
												...
												<ul>
													...
													<li>
														<label class="mm_form-radio">
															...
															<b class="mm_block">
																<i class="ico_form-radio"></i>
																<span class="text_label">셀러 전체 상품</span>
															</b>
														</label>
													</li>
												</ul>
