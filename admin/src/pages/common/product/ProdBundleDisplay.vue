			...
			<div class="mm_page-content">
				...
				<div class="mm_container">
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="7">
										...
										<div class="mm_note">
											<ul>
												<li><strong>줄바꿈</strong>으로 구분하여 다중 검색 가능 (최대 300줄)</li>
											</ul>
										</div>
									</td>
								</tr>
									...
									<table>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<span class="text_price">12500</span>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
														<span class="text_price">12000</span>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
					...
					<div class="mm_form_box">
										...
										<td colspan="3">
											<div class="mm_radio-list">
												<ul>
													<li>
														<label class="mm_form-radio">
															<input type="radio" name="dev_radio-select" data-radio checked>
															<b class="mm_block">
																<i class="ico_form-radio"></i>
																<span class="text_label">검색된 전체 상품 일괄 변경</span>
															</b>
														</label>
													</li>
													<li>
														<label class="mm_form-radio">
															<input type="radio" name="dev_radio-select" data-radio>
															<b class="mm_block">
																<i class="ico_form-radio"></i>
																<span class="text_label">선택된 상품 일괄 변경</span>
															</b>
														</label>
													</li>
												</ul>
										...
										<td colspan="3">
											<div class="mm_radio-list">
												<ul>
													<li>
														<label class="mm_form-radio">
															<input type="radio" name="dev_radio-set-display" data-radio checked>
															<b class="mm_block">
																<i class="ico_form-radio"></i>
																<span class="text_label">진열</span>
															</b>
													...
													<li>
														<label class="mm_form-radio">
															<input type="radio" name="dev_radio-set-display" data-radio>
															<b class="mm_block">
																<i class="ico_form-radio"></i>
																<span class="text_label">미진열</span>
															</b>
						...
						<div class="mm_note">
							<ul>
								<li>진열 상태일 경우 쇼핑몰 프론트에 정상 노출됩니다. (진열 상태에서도 <strong>재고가 0일 경우 품절 상태로 자동 변경</strong>됩니다.)</li>
								<li>미진열 상태일 경우 쇼핑몰 <strong>프론트에 노출되지 않습니다.</strong></li>
								<li>품절 상태일 경우 쇼핑몰 프론트에 <strong>[SOLD OUT] 상태로 노출됩니다.</strong></li>
								<li>품절 상태 변경 후 <strong>90일 경과 시 미진열 상태로 자동 변경</strong>됩니다.</li>
								<li>품절 상태 변경 후 <strong>재고가 생길 경우 진열 상태로 자동 변경</strong>됩니다.</li>
								<li>선택된 상품 일괄 변경을 할 경우 <strong>같은 페이지에 있는 상품에 한해서 가능</strong>합니다.</li>
							</ul>
						</div>
						<!-- // 유의사항 -->
					</div>
									...
									<td colspan="3">
										<div class="mm_form_mix-linked">
											<div class="mm_form-file">
												...
												<label>
													<input type="file" accept=".xlsx, .xls" data-file="{ '_fileName': 'display_product' }">
													<span class="text_path"></span>
													<span class="mm_btn T=line T=light text_label">파일첨부</span>
												</label>
											</div>
											<a class="btn_sample" href="#" download="display_product.xls"><b>샘플다운받기</b></a>
										...
										<div class="mm_note T=bottom">
											<ul>
												<li><strong>display_product 파일명만 업로드가 가능</strong>합니다. (xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가)</li>
