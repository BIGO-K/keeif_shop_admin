					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="/product/gift/register" data-href="{ '_type': 'link' }"><b>사은품 등록하기</b><i class="ico_register"></i></a>
									<div class="mm_note">
									...
									<table>
										<thead>
											<tr>
												...
												<th scope="col">
													<div class="mm_table-item">
														<span>사은품 이미지</span><button type="button" class="btn_preview-toggle" title="이미지 미리보기 켜기">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/product/gift/coverage" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>셀러A 전체 상품</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<div><span class="text_num">31</span> / <span class="text_num">100</span></div>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="/product/gift/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/product/gift/coverage" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>상품</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
												...
												<td>
													<div class="mm_table-item">
														<div><span class="text_num">476</span> / <span class="text_num">500</span></div>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<div><span class="text_num">18</span> / <span class="text_num">230</span></div>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
