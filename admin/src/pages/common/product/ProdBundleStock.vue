			...
			<div class="mm_page-content">
				...
				<div class="mm_container">
					...
					<div class="mm_form_box">
						...
						<div class="mm_note">
							<ul>
								<li>변경 가능 <strong>최대 재고 수량은 999</strong>입니다.</li>
								<li>재고 수량을 0으로 변경 시 <strong>해당 옵션은 품절</strong>됩니다.</li>
									...
									<td colspan="3">
										<div class="mm_form_mix-linked">
											<div class="mm_form-file">
												...
												<label>
													<input type="file" accept=".xlsx, .xls" data-file="{ '_fileName': 'stock_product' }">
													<span class="text_path"></span>
													<span class="mm_btn T=line T=light text_label">파일첨부</span>
												</label>
											</div>
											<a class="btn_sample" href="#" download="stock_product.xls"><b>샘플다운받기</b></a>
										...
										<div class="mm_note T=bottom">
											<ul>
												<li><strong>stock_product 파일명만 업로드가 가능</strong>합니다. (xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가)</li>
