									...
									<td colspan="7">
										<div class="mm_form-select T=lg">
											<label>
												<select data-select>
													<option>전체</option>
													<option>관리자 수동 탈퇴 처리</option>
													<option>상품 품질 불만</option>
													<option>고객 서비스 불만</option>
													<option>원하는 상품이 없음</option>
													<option>속도가 느림</option>
													<option>배송 지연</option>
													<option>교환/환불 불만</option>
										...
										<tbody>
											...
											<tr>
												...
												<td class="T=table-left">
													<div class="mm_table-item">
														<p class="T=linebreak">
															<b>관리자 수동 탈퇴 처리, 상품 품질 불만, 원하는 상품이 없음, 고객 서비스 불만, 속도가 느림, 배송 지연, 교환/환불 불만, 자주 이용하지 않음</b>
														</p>
													</div>
												</td>
												<td>
