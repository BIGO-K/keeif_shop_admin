										...
										<div class="mm_form_mix-period">
											<div class="mm_form-select T=xs">
												<label>
													<select data-select>
														<option>등록일자</option>
														<option>출고 불가 시작일</option>
														<option>출고 불가 종료일</option>
													</select>
													<b class="text_selected"></b>
													<i class="ico_form-select"></i>
												</label>
											...
											<ul>
												...
												<li>
													<label class="mm_form-radio">
														...
														<b class="mm_block">
															<i class="ico_form-radio"></i>
															<span class="text_label">노출 예약</span>
														</b>
													</label>
												</li>
												<li>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="/seller/manage/offday/register" data-href="{ '_type': 'link' }"><b>휴무일 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>휴무일 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="/seller/manage/offday/register" data-href="{ '_type': 'link' }"><b>휴무일 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>휴무일 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
