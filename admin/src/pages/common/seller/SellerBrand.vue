											...
											<ul>
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-attribute" data-radio checked>
														<b class="mm_block">
												...
												<li>
													<label class="mm_form-radio">
														<input type="radio" name="dev_radio-attribute" data-radio>
														<b class="mm_block">
															<i class="ico_form-radio"></i>
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="brand/register" data-href="{ '_type': 'link' }"><b>브랜드 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>브랜드 수<b class="mm_text-secondary"><strong class="text_num">1234</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="brand/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="brand/register" data-href="{ '_type': 'link' }"><b>브랜드 등록하기</b><i class="ico_register"></i></a>
									<ul class="mm_table-status">
										<li>브랜드 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
