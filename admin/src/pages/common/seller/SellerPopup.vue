											...
											<ul>
												<li>
													<label class="mm_form-check">
														<input type="checkbox" name="dev_check-using" data-check checked>
														<b class="mm_block">
					...
					<template v-if="_isNone === false">
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<a class="mm_btn T=line T=secondary btn_register" href="popup/register" data-href="{ '_type': 'link' }"><b>팝업 등록하기</b><i class="ico_register"></i></a>
								</div>
								<div class="mm_rside">
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/seller/popup/preview" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>일반 문의 관련 팝업</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="popup/modify" data-href="{ '_type': 'link' }"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/seller/popup/preview" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>정산 변경에 따른 팝업입니다</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/seller/popup/preview" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>시스템 업데이트 팝업</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/seller/popup/preview" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>시스템 오류에 대한 팝업</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
											...
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<a href="/seller/popup/preview" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>정산 처리 오류에 대한 팝업</b></a>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
