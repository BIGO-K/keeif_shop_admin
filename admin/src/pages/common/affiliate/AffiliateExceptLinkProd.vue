							...
							<tbody>
											...
											<ul>
												<li>
													<label class="mm_form-check">
														<input type="checkbox" name="dev_check-seller" data-check>
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">11번가</span>
														</b>
													</label>
												</li>
												<li>
													<label class="mm_form-check">
														...
														<b class="mm_block">
															<i class="ico_form-check"></i>
															<span class="text_label">G마켓</span>
														</b>
													</label>
												</li>
												<li>
								...
								<tr>
									...
									<td colspan="7">
										...
										<!-- (D) MD 관리자 접근 시 노출되는 형태 -->
										<!--
											<div class="mm_form-select T=sm">
											<label>
											<select data-select disabled>
											<option>여성패션 MD</option>
											</select>
											<b class="text_selected"></b>
											<i class="ico_form-select"></i>
											</label>
						...
						<div class="mm_table_box">
							...
							<div class="mm_table_box-unit">
								<div class="mm_lside">
									<div class="mm_btn_box">
										<div class="mm_inline">
											<a class="mm_btn T=line T=secondary" href="/affiliate/except-link/prod/register" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>상품 추가</b></a>
											<button type="button" class="mm_btn T=line">
												<b>선택 삭제</b>
											</button>
											<a class="mm_btn" href="/affiliate/except-link/prod/modify" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>선택 수정</b></a>
										</div>
									</div>
								</div>
								<div class="mm_rside">
									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="mm_table-item">
														<span class="text_price">42312</span>
													</div>
												</td>
												<td>
													<div class="mm_table-item">
													...
													<div class="mm_table-item">
														<div class="mm_btn_box">
															<div class="mm_inline">
																...
																<a class="mm_btn T=sm" href="/affiliate/except-link/prod/modify" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>수정</b></a>
															</div>
														</div>
													</div>
												</td>
									...
									<div class="mm_form_mix-linked">
										<div class="mm_form-text">
											<label>
												...
												<span class="text_placeholder">숫자</span>
											</label>
										</div>
							...
							<div class="mm_note">
								<ul>
									<li>목록에 있는 상품은 제휴 연동에서 제외됩니다.</li>
									<li>목록의 같은 페이지에 노출되고 있는 항목에 대해서만 [선택수정], [선택삭제]가 가능합니다.</li>
									<li>엑셀 업로드 시 바로 저장 및 적용됩니다.</li>
								</ul>
							</div>
							<!-- // 유의사항 -->
						</div>
					...
					<template v-else>
						<div class="mm_table_box">
							...
							<div class="mm_table_box-caption">
								<div class="mm_lside">
									<ul class="mm_table-status">
										<li>상품 수<b class="mm_text-secondary"><strong class="text_num">0</strong>개</b></li>
									</ul>
								</div>
								<div class="mm_rside">
									<div class="mm_form-select T=list">
							...
							<div class="mm_table_box-unit">
								<div class="mm_lside">
									<div class="mm_btn_box">
										<div class="mm_inline">
											<a class="mm_btn T=line T=secondary" href="prod/register" data-href="{ '_type': 'popup' }" title="새 창 열림"><b>상품 추가</b></a>
										</div>
									</div>
								</div>
							</div>
									...
									<td colspan="3">
										<div class="mm_form_mix-linked">
											<div class="mm_form-file">
												...
												<label>
													<input type="file" accept=".xlsx, .xls" data-file="{ '_fileName': 'linkage_exception_seller_alliance' }">
													<span class="text_path"></span>
													<span class="mm_btn T=line T=light text_label">파일첨부</span>
												</label>
											</div>
											<a class="btn_sample" href="#" download="linkage_exception_seller_alliance.xls"><b>샘플다운받기</b></a>
										...
										<div class="mm_note T=bottom">
											<ul>
												<li><strong>linkage_exception_seller_alliance 파일명만 업로드가 가능</strong>합니다. (xls/xlsx 확장자를 제외한 파일 및 이미지는 업로드 불가)</li>
												<li>파일 지정 후 업로드 버튼 클릭 시 상단 목록에 적용되어 노출됩니다.</li>
												<li>업로드 시, 동일한 데이터를 가진 항목은 유지되고 변동이 있거나 신규 추가된 항목만 업로드되어 노출됩니다.</li>
												<li>항목 삭제는 엑셀 파일이 아닌 목록의 삭제 버튼을 통해서만 가능합니다.</li>
												<li>엑셀 업로드 시 바로 <strong>저장 및 적용</strong>됩니다.</li>
											</ul>
										</div>
									</td>
								</tr>
